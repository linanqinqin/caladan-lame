...
uint64_t cfg_lame_avx_page_size = 64;
/* end */
...
static int parse_runtime_lame_avx_page_size(const char *name, const char *val)
{
	cfg_lame_avx_page_size = atoi(val);
	return 0;
}
/* end */
...
static const struct cfg_handler cfg_handlers[] = {
	...
	{ "runtime_lame_avx_page_size", parse_runtime_lame_avx_page_size, false },
	/* end */
